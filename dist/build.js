...
function buildWorker(context) {
    return Promise.resolve().then(function () {
        ...
        .then(function (_a) {
        var appEntryPointContents = _a[0], tsConfigContents = _a[1];
...
function buildUpdateTasks(changedFiles, context) {
    ...
    return Promise.resolve()
        ...
        if (context.sassState === interfaces_1.BuildState.RequiresUpdate) {
            ...
            return sass_1.sassUpdate(changedFiles, context).then(function (outputCssFiles) {
                outputCssFiles.forEach(function (outputCssFile) {
                    var changedFile = {
            ...
            return sass_1.sass(context).then(function (outputCssFiles) {
                outputCssFiles.forEach(function (outputCssFile) {
                    var changedFile = {
                        event: Constants.FILE_CHANGE_EVENT,
                        ext: '.css',
