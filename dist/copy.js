...
function copy(context, configFile) {
    var configFiles = config_1.getUserConfigFile(context, exports.taskInfo, configFile);
...
function copyUpdate(changedFiles, context) {
    ...
    var configFile = config_1.getUserConfigFile(context, exports.taskInfo, null)[0];
    var copyConfig = config_1.fillConfigDefaults(configFile, exports.taskInfo.defaultConfigFile);
    var keys = Object.keys(copyConfig);
    var directoriesToCreate = new Set();
    var toCopyList = [];
...
function copyConfigToWatchConfig(context) {
    ...
    var configFiles = config_1.getUserConfigFile(context, exports.taskInfo, '');
    var copyConfig = config_1.fillConfigDefaults(configFiles[0], exports.taskInfo.defaultConfigFile);
    var results = [];
