...
describe('util', function () {
    describe('hydrateRequest', function () {
        it('should take a component request and return a hydrated component request', function () {
            ...
            var templateDir = '/Users/noone/project/node_modules/ionic-angular/templates';
        ...
        it('should take a page request and return a hydrated page request', function () {
            // arrange
            var pagesDir = '/Users/noone/project/src/pages';
            var context = {
                pagesDir: pagesDir
            };
            var request = {
    ...
    describe('readTemplates', function () {
        it('should get a map of templates and their content back', function () {
            ...
            var knownValues = ['html.tmpl', 'scss.tmpl', 'spec.ts.tmpl', 'ts.tmpl', 'module.tmpl'];
    ...
    describe('filterOutTemplates', function () {
        ...
        it('should remove spec and module', function () {
            ...
            var templateDir = '/Users/noone/project/node_modules/ionic-angular/templates/component';
            var fileContent = 'SomeContent';
            var knownValues = ['html.tmpl', 'scss.tmpl', 'spec.ts.tmpl', 'ts.tmpl', 'module.ts.tmpl'];
            map.set(path_1.join(templateDir, knownValues[0]), fileContent);
            map.set(path_1.join(templateDir, knownValues[1]), fileContent);
            map.set(path_1.join(templateDir, knownValues[2]), fileContent);
            map.set(path_1.join(templateDir, knownValues[3]), fileContent);
    ...
    describe('writeGeneratedFiles', function () {
        it('should return the list of files generated', function () {
            ...
            return promise.then(function (filesCreated) {
                var fileExtensions = knownValues.map(function (knownValue) { return path_1.basename(knownValue, GeneratorConstants.KNOWN_FILE_EXTENSION); });
    ...
    describe('getDirToWriteToByType', function () {
        ...
        beforeEach(function () {
            context = { componentsDir: componentsDir, directivesDir: directivesDir, pagesDir: pagesDir, pipesDir: pipesDir, providersDir: providersDir };
        });
    ...
    describe('tabsModuleManipulation', function () {
        var className = 'SettingsView';
        var fileName = 'settings-view';
        var suppliedName = 'settings view';
        it('should return a succesful promise', function () {
            ...
            var promise = util.tabsModuleManipulation([['/src/pages/cool-tab-one/cool-tab-one.module.ts']], { name: suppliedName, className: className, fileName: fileName }, [{ name: suppliedName, className: className, fileName: fileName }]);
            return promise.then(function () {
                expect(helpers.readFileAsync).toHaveBeenCalled();
                expect(helpers.writeFileAsync).toHaveBeenCalled();
            });
        });
        it('should throw when files are not written succesfully', function () {
    ...
    describe('nonPageFileManipulation', function () {
        var componentsDir = '/path/to/components';
        var directivesDir = '/path/to/directives';
        var pagesDir = '/path/to/pages';
        var pipesDir = '/path/to/pipes';
        var providersDir = '/path/to/providers';
        var context = { componentsDir: componentsDir, directivesDir: directivesDir, pagesDir: pagesDir, pipesDir: pipesDir, providersDir: providersDir };
        beforeEach(function () {
            var templateDir = '/Users/noone/project/node_modules/ionic-angular/templates';
            spyOn(helpers, helpers.getStringPropertyValue.name).and.returnValue(templateDir);
        });
        it('should return a succesful promise', function () {
            ...
            var promise = util.nonPageFileManipulation(context, 'coolStuff', '/src/pages/cool-tab-one/cool-tab-one.module.ts', 'pipe');
            // test
            return promise.then(function () {
                expect(helpers.readFileAsync).toHaveBeenCalled();
                expect(helpers.writeFileAsync).toHaveBeenCalled();
