...
function optimizationEnabled() {
    var purgeDecorators = helpers_1.getBooleanPropertyValue(Constants.ENV_EXPERIMENTAL_PURGE_DECORATORS);
...
function getConfig(context, configFile) {
    ...
    var webpackConfig = config_1.fillConfigDefaults(configFiles[0], taskInfo.defaultConfigFile);
