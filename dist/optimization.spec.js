...
describe('optimization task', function () {
    ...
    describe('purgeGeneratedFiles', function () {
        it('should remove files in buildDir with suffix from the cache', function () {
            var buildDir = '/some/fake/dir/myApp/www/build';
            var context = {
            ...
            var filePathFive = path_1.join('some', 'fake', 'dir', 'myApp', 'src', "app.ts");
            var filePathSix = path_1.join('some', 'fake', 'dir', 'myApp', 'src', "app.js");
            var filePathSeven = path_1.join('some', 'fake', 'dir', 'myApp', 'src', 'pages', "1." + suffix);
