...
function getClassDeclarations(sourceFile) {
    var classDeclarations = findNodes(sourceFile, sourceFile, typescript_1.SyntaxKind.ClassDeclaration, true);
    if (classDeclarations.length > 1) {
        logger_1.Logger.warn("The following file has multiple class declarations in it:\n" + sourceFile.fileName + "\nIn general, it's considered a best practice to have at most one class declaration per file.");
    }
